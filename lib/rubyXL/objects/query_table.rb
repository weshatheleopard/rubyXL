...
module RubyXL
  ...
  class QueryTableFields < OOXMLObject
    define_child_node(RubyXL::QueryTableField, :collection => :with_count, :accessor => :fields,
:node_name => :queryTableField)
  ...
  class QueryTableDeletedFields < OOXMLObject
    define_child_node(RubyXL::QueryTableDeletedField, :collection => :with_count, :accessor => :deleted_fields,
:node_name => :deletedField)
