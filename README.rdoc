...
Please note that proprietary binary +xls+ format is *not* supported. For that one, you will need to look at `[spreadsheet](https://github.com/zdavatz/spreadsheet)` gem.
