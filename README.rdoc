...
This gem supports operating on +xlsx+ files (Open XML format). Its current main is on
reading files produced by Excel, making minor modifications to them and saving them to
be opened again.
