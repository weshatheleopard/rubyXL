...
Please note that worksheets are sparse collections. Your code *must* expect that any row it encounters may be <tt>nil</tt>.
...
Please note that rows are sparse collections. Your code *must* expect that any cell it encounters may be <tt>nil</tt>.
